    ...
    <xsl:copy>
      ...
      <div id="feedback">
        ...
        <ul class="button-list button-list--ico">
          ...
          <li class="donation"><a href="https://www.patreon.com/pralek" title="Přejít na stránky Patreonu" class="button button--img button--img-inline"><span class="fab fa-fw fa-patreon">i</span> Staňte se patronem</a></li>
          <li class="ebook"><a href="#ebook" title="Nová elektronická kniha" class="button button--img button--img-inline"><span class="fab
