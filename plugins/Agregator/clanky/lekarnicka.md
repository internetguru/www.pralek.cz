...
Níže vyjmenované nástroje a základní zdravotní materiál postačí k vybavení domácí lékárničky. Je však vhodné upravit její obsah s ohledem na jednotlivé členy rodiny – na jejich časté nebo dlouhodobé nemoci (např. [alergie][1]), aktivity a životní styl.
...
Nástroje v lékárničce mají být samozřejmě čisté. Před každým léčebným použitím je třeba je [vydezinfikovat][2] a po použití mechanicky očistit. To platí např. i pro kontaktní teploměr, kde hrozí riziko [přenosu plísní][3].

Lékařský teploměr
:   Základní typy teploměrů jsou lihový, rtuťový a digitální. [Teplotu měří][4] v zásadě všechny stejně dobře, jen různě rychle. Nejrychlejší je bezkontaktní digitální teploměr vhodný obzvlášť pro měření teploty malých dětí.
...
Pinzeta
:   K mechanickému odstranění třísek, částeček [nečistot z oděrky][5], [zabodnutého žihadla][6] nebo [přisátého klíštěte][7] poslouží stejně dobře anatomická, kosmetická nebo jiná pinzeta.
...
Zubní kartáček
:   Nepoužitý zubní kartáček v originálním balení výborně poslouží k [vyčištění rány nebo oděrky][5]. Použitý kartáček je pro tyto účely nevhodný.
...
Dezinfekce
:   K chemickému vyčištění oděrky, rány (i jejího okolí) nebo protrženého [puchýře][8] od [mikroorganizmů][2] poslouží nejlépe Betadine roztok (který v ráně neštípe).
:   Také lze použít dezinfekci zakoupenou v lékárně (běžně ve spreji) – přímo určenou k dezinfekci kůže nebo nástrojů.

Novikovův roztok
:   Poloprodyšné [krytí na dobře očištěné oděrky][5] v zelené nebo i bezbarvé formě.

Obvazy různé velikosti
:   K obvázání rány kryté sterilní gázou nebo čistým přežehleným kapesníkem postačí nesterilní obvaz. Sterilní obvaz lze použít přímo [na ránu][9] nebo oděrku.
...
:   Je dobré mít v lékárničce základní léky [proti bolesti a teplotě][17]. Bolest je dobré tlumit až po poznání její příčiny (s výjimkou např. [migrény][18]). [Teplotu][4] snižovat až po nárůstu nejméně o 1 °C oproti normálu.
...
Léky proti alergii
:   I když není v rodině žádný alergik, je dobré mít v lékárničce základní lék [proti alergii][21]. Alergie totiž může vzniknout kdykoli i při plném zdraví. Kromě toho může být potřeba pomoci s alergickou reakcí kamarádovi či sousedovi.

Višněvského emulze (hovorově „višňák“)
:   Protizánětlivá emulze dobře poslouží [k léčbě počínajícího zánětu][22].

Oční voda
:   V případě [poranění nebo poleptání oka][23] (nejčastěji vápnem při zednických pracích) je nutné oko opakovaně vyplachovat. Rovněž při [vniknutí cizího tělíska do oka][24] pomůže opakovaný výplach oko zklidnit.
...
V mrazáku je dobré mít modrý chladivý gel _(kryoperlóza)_ nebo jeho náhražku – nadrobno nakrájenou zeleninu v plastovém sáčku. Obsah musí být tvárný aby přilnul ke chlazenému místu. Jen tak může dobře posloužit ke chlazení [spáleniny][14] nebo jakéhokoli počínajícího [místního zánětu][22]. 
...
n/a
 ...
 [3]: plisne_kuze
 [4]: teplota
 [5]: odreniny_neboli_oderky
 [6]: poraneni_jedovatym_zviretem
 [7]: prisate_kliste
 [8]: puchyr_mozol_kuri_oko
 [9]: bodne_a_strelne_poraneni
 [10]: naplastovy_steh
 ...
 [21]: imunita
 [22]: lecba_zanetu
 [23]: nalehavost_lekarskeho_vysetreni
 [24]: telisko_v_oku
