...
Záludnost cévní mozkové příhod spočívá v nenápadnosti jejího nástupu a v jejím pozvolném a nebolestivém rozvoji.

{class="example"}

Cévní mozková příhoda (CMP) se také jinak nazývá jako mozkové mrtvice, iktus či mozkový infarkt.

Mozková mrtvice je způsobena nedokrvením části mozku z důvodu [zúžení nebo ucpání cév][1] vyživujících mozek. Může se také jednat o prokrvácení části mozku z důvodu prasknutí nemocné cévy.
...
Stejné příznaky jako jsou uvedeny níže mohou doprovázet jak neúrazové, tak [úrazové krvácení do mozku][7].
  ...
  * Pokleslý koutek úst.
  * Často nevýrazné projevy samovolně ustoupí a s odstupem hodin se znovu vrátí, tentokrát závažnější. {class="important"}
...
Postižená část mozku přestala fungovat a její funkci se snaží nahradit ostatní části mozku, impulsy si hledají jiné (náhradní) dráhy. Proces je dlouhodobý a rehabilitace je velmi náročná pro postiženého i pro jeho blízké.
